...
def main():
    ...
    # Optional arguments
    parser.add_argument('--centroids_path', type=str, default="./data/processed_data/primary_k1024/1024_primary_centroids.pk",
                        help='Path to the pre-computed centroids .pk file.')
    parser.add_argument('--output_dir', type=str, default="./data/processed_data/datasets_mtx_1024_downstream",
